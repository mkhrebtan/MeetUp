...
namespace MeetUp.Infrastructure.Migrations
{
    ...
    [Migration("20251207193525_Record_Views_Init")]
    partial class Record_Views_Init
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeetUp.Domain.Models.RecordViews", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("RecordingStorageKey")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("RecordingStorageKey")
                        .IsUnique();

                    b.ToTable("RecordViews");
                });
            ...
            modelBuilder.Entity("MeetUp.Domain.Models.Workspace", b =>
                {
                    ...
                    b.Property<string>("MeetingsCreationPolicy")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MeetUp.Domain.Models.SharedRecord", b =>
                {
                    b.HasOne("MeetUp.Domain.Models.User", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MeetUp.Domain.Models.User", "Recipient")
                        .WithMany()
